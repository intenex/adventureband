...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.dungeon'
        db.add_column('band_character', 'dungeon', self.gf('django.db.models.fields.IntegerField')(default=101), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Character.dungeon'
        db.delete_column('band_character', 'dungeon')
