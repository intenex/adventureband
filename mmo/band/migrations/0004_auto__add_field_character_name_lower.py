...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.name_lower'
        db.add_column('band_character', 'name_lower', self.gf('django.db.models.fields.CharField')(default='grandfather', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Character.name_lower'
        db.delete_column('band_character', 'name_lower')
