...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.gold'
        db.add_column('band_character', 'gold', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Character.gold'
        db.delete_column('band_character', 'gold')
