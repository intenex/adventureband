...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.current_hp'
        db.add_column('band_character', 'current_hp', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'Character.max_hp'
        db.add_column('band_character', 'max_hp', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Character.current_hp'
        db.delete_column('band_character', 'current_hp')

        # Deleting field 'Character.max_hp'
        db.delete_column('band_character', 'max_hp')
