...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('band_character', 'weapon', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.ranged'
        db.add_column('band_character', 'ranged', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.body'
        db.add_column('band_character', 'body', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.left_finger'
        db.add_column('band_character', 'left_finger', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.right_finger'
        db.add_column('band_character', 'right_finger', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.shield'
        db.add_column('band_character', 'shield', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.hands'
        db.add_column('band_character', 'hands', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.head'
        db.add_column('band_character', 'head', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.feet'
        db.add_column('band_character', 'feet', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)

        # Adding field 'Character.quiver'
        db.add_column('band_character', 'quiver', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True), keep_default=False)
